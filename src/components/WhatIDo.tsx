        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Performing rigorous exploratory data analysis (EDA), data cleaning, and statistical modeling to drive business decisions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing end-to-end ML pipelines for predictive analytics, forecasting, and deriving actionable intelligence.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
